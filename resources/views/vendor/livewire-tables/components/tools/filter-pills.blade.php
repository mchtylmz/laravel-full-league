...
@if ($this->filtersAreEnabled() && $this->filterPillsAreEnabled() && $this->hasAppliedVisibleFiltersForPills())
    <div>
        <div @class([
            ...
            'mb-3 bg-light p-2' => $isBootstrap,
        ]) x-cloak x-show="!currentlyReorderingStatus">
            <small @class([
                'text-gray-700 dark:text-white' => $isTailwind,
                'fw-bold me-2' =>  $isBootstrap,
            ])>
                ...
                @else
                    <span
                        ...
                        @class([
                            ...
                            'badge rounded-pill bg-success d-inline-flex align-items-center' => $isBootstrap5,
                        ])
                    >
            ...
            @else
                <a
                    ...
                    @class([
                        ...
                        'badge rounded-pill bg-danger' => $isBootstrap5,
                    ])
                >
                    @lang('Clear') <i class="fa fa-times fa-fw"></i>
                </a>
            @endif
        </div>
    </div>
